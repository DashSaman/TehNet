...
MTCNA_ID="$(ensure_page mtcna 'آموزش MTCNA میکروتیک' "$ROOT/content/pages/learn-mikrotik-mtcna.html")"
wp_cli post update "$MTCNA_ID" --post_parent="$MIKROTIK_ID" >/dev/null
